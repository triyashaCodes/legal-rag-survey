# Run all frameworks on LEDGAR task
...
# Load LEDGAR index
print("Loading LEDGAR index...")
index_path = INDEX_PATHS["LEDGAR"]
...
dataset_path = DATASET_PATHS["LEDGAR"]

print(f"\n{'='*60}")
print("Running LEDGAR Evaluation")
print(f"{'='*60}\n")
...
print(f"\n{'='*60}")
print("LEDGAR evaluation complete!")
print(f"{'='*60}")
