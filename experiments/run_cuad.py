# Run all frameworks on CUAD task
...
dataset_path = DATASET_PATHS["CUAD"]

print(f"\n{'='*60}")
print("Running CUAD Evaluation")
print(f"{'='*60}\n")
...
print(f"\n{'='*60}")
print("CUAD evaluation complete!")
print(f"{'='*60}")
